    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-center md:justify-end gap-5 md:gap-10">
          <Link className="hover:border-2 text-xs text-center hover:border-bg-primary text-bg-secondary bg-bg-primary font-semibold  rounded-md text-md px-2 py-2 md:text-lg md:px-5 md:py-3 hover:text-bg-primary hover:bg-bg-secondary">
            Discover More
          </Link>
          <Link className="border-2 text-xs text-bg-secondary text-center font-semibold border-bg-primary rounded-md text-md px-2 py-2 md:text-lg md:px-5 md:py-3 hover:text-white hover:bg-bg-primary ">
            Latest Project
          </Link>
        </div>
      </div>
